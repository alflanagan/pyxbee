...
class XBeeSettings(object):
    """
    This object represents the settings for an XBee radio. It's somewhat smart
    about knowing how to retrieve the settings, and what they mean.
    """

    def __init__(self, xbee_device, *args, **kwargs):
        """
        Constructor
